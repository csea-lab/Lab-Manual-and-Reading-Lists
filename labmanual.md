...
- **Integrity & reproducibility**: The goal of science is to produce a corpus of knowledge that can be trusted. Honest mistakes happen in any area of human activity. We are open about problems, mistakes, and successess. We share our data and code openly with all interested researchers. We are committed to [open, programmatric, systematic, science](Readings/Garrett_Ruffin2021.pdf). This includes a strong committment to pre-registration of our studies and to transparency during all stages of the reearch process.
