...
2. [Ethics & Guiding Principles](#ethics--guiding-principles)
...
## Mission Statement
The Laboratory for Brain, Body, & Behavior (LB3) at the University of Florida uses the tools of human neuroscience and psychophysiology to advance our understanding of how people perceive and respond to environmental challenges. Our work spans three main areas:
- **Research**: We implement and execute cutting-edge research that is methodological rigorous. Our work is collaborative and is aligned with the contributions of scientists across the globe. In our view, science does not progress rapidly through one-off novel findings, but through systematic and programmatic investigation. For those interested in the philosophy and values of the lab, consider reading [Pavlov's letter to young scientists](https://www.physoc.org/magazine-articles/from-the-archives-pavlovs-bequest/) as well as [this essay](https://onlinelibrary.wiley.com/doi/full/10.1111/psyp.12608) by our former colleague Prof. Margaret Bradley, on programmatic science. 
- **Training and education**: Research training is a major focus of the lab. Undergraduate researchers, graduate students, and postdoctoral researchers contribute to our lab's success in different roles, and receive training in a wide range of methods. Visiting researchers and trainees are welcome in our lab. In addition, we contribute to the mission of UF in higher education, through teaching in the UF Department of Psychology, as well as in other departments.  
- **Service and outreach**: The lab contributes to the dissemination, organization, and facilitation of research and education in a variety of roles. This includes serving on editorial boards of scientific journals, scientific societies, grant review panels, advisory boards for foundations, roles in industry, and in service roles at UF. It also includes outreach activities with media and schools. 

---

## Ethics & Guiding Principles
We hold ourselves accountable to quantifiable standards for conducting systematic research.  
These standards include:
- **Integrity & reproducibility**: The goal of science is to produce a corpus of knowledge that can be trusted. Honest mistakes happen in any area of human activity. We are open about problems, mistakes, and successess. We share our data and code openly with all interested researchers. We are committed to [open, programmatric, systematic, science](https://psyarxiv.com/ryspq/download). This includes a strong committment to pre-registration of our studies and to transparency during all stages of the reearch process. 
...
The PI of the lab is Andreas Keil. His job is to direct all aspects of the lab's activities and take responsibility for these activities. This role includes activities such as securing funding, training of lab members, providing a healthy workplace structure, providing service to the discipline, and dissemination/sharing/publication of the lab's work. He also is an active researcher in the lab, who participates in study design, data analysis, code writing/testing/sharing, and collaboration with other researchers, here at UF, or in other locations. At different times, he may have other duties. e.g., as journal editor, grant reviewer, or member of some other research body, which may be relevcant to some lab members. Specifically, Andreas is responsible for the following things:
- The scientific vision of the lab
- The sources of funding and collaborations we have
- Compliance with university and federal regulations
- Compliance with our own ethical standards
- Mentoring and training of lab members
- Support in career development and networking
- Publications, authorship, and personnel allocation to projects

Andreas can be a resource for you in the following ways: 
- He will keep track of your progress, encourage you, and advise you where needed. Everyone has different mentoring needs; let him know what is most helpful for you. Do not wait for annual check-in meetings to give feedback, mentoring and training is an important part of the lab's mission, and we want to make sure that we do the best possible job. 
- If you have a manuscript draft, Andreas will typically read and comment on it within a few days. If he does not, please remind him -- his task tracking system has failed you both :-) 
- When his door is open, he is always happy to chat about something that you have read, epxlain lab practices, or answer questions regarding the lab, the field, or science topics more broadly. 
- He will also answer questions regarding administrative things as well as possible, but he is not very knowledgable with respect to forms, processes, and rules. 
...
A typical graduate student career may look like this: 
- **Year 1**: Work with an existing dataset to implement basic preprocessing and postprocessing steps; learn coding if needed; understand the logic and foundations that inform data analysis and interpretation, including the biophysical basis of neural signals; learn to plan, conduct, and supervise data recording sessions with EEG and or EEG/fMRI as well as autonomic measures. Acquire basic conceptual knowledge about theoretical and methodological foudations or your work so that you can draft a first-authored paper about a specific topic at the end of your first year. 
- **Year 2**: Expand the corpus of knowledge from Year 1, and work more independently. Analyze, interpret, and write up the data from a complete study. Hone professional skills such as presenting your research locally and at international conferences and working on multiple projects simultaneously. Become involved in experimental design of future studies. Present your work at conferences and contribute to lab publications as co-author. Write up one first-authored paper on your work. 
- **Year 3**: Finish Master's thesis unless you have transferred an equivalent thesis, from another activity/institution, to UF; put together topics for the qualification exam; plan your dissertation project. Expand mentoring of undergraduate researchers, increase autonomy in analytical techniques, coding, open science approaches, research ethics, and pre-registrations; expand professional knowledge of the publication process; get involved in service and or scientific societies as a student representative. 
...
- **Year 5**: Finish up dissertation; plan post-doctoral career in academia, industry, or other sector, in close communication with mentor. Write-up and publish dissertation manuscript(s). Practice towards activities such as interviewing for positions, networking towards inducstry jobs, writing post-doc grants. Let your mentor know where you would like your farewell dinner/party to take place. 

Training in human neuroscience can be, and should be, very gratifying and fun for people with an inquisitive mind. We are tackling some of the most fascinating problems that exist in science, and we are a strong community of like-minded people. Despite all this, graduate training can be a stressful time and many of us had or have difficulties with this role, feeling inadequate, overwhelmed, or tired. The PI is committed to help you deal with challenges that affect your ability to enjoy your training. There are also many other resources available on campus, through various entities and groups. In the case of conflict, please follow the conflict resolution policies of the lab, which involve bringing potential conflict to the PI early and without hesitation. 
...
- Organize and perform data collection, management, and preliminary analysis.
- Gain technical and professional experience in preparation for graduate school.
- Contribute to manuscripts and presentations when appropriate.

An important goal of the post-bacc role is to find out if you enjoy doing the tasks that are inherent in the research process and if graduate school is right for you. If you find yourself bored or demotivated, or if you are absent from the lab a lot, then maybe there is a lack of fit with the type of research we are doing, or research in general. Considering this may provide important information about your future career. The PI is happy to discuss this with you. 
**->** An alternative role for post-baccalaureate researchers is to perform duties such as data recording, lab management, regulatory compliance, data organization and sharing. These are valuable contributions to the lab, which may be completed by someone hwho does not have a graduate career in mind. Instead, people in this role may be working towards a career in research administration and coordination. At times, lab members in the post-bacc role will change career plans from graduate programs to administration or coordination careers. Figuring out one's career goals is important and within the lab's mission. Please ensure that the PI and other people in mentoring roles know what your goals are and if they change, so that they can best support you.   

### Undergraduate Research Assistants
One imporant component of the lab's mission is to provide reserch training to UF undergraduate students. Typically, students will reach out to us and undergo a selection process which focuses on prior research experience, evidence of professionalism, and availability. Upon admission to the lab, they will have access to the following experiences, which also provide crucial assistance to the lab's mission: 
- Assist with data collection, coding, and literature reviews.
- If interested, may participate in lab meetings and journal clubs.
- Learn research ethics, methodology, and teamwork.
- Commit to reliability and clear communication.
